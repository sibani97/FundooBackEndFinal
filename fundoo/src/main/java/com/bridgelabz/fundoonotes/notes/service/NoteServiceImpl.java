...
public class NoteServiceImpl implements NoteService {
	...
	//Notes note = user.getNotes().stream().filter(data -> data.getNoteId().equals(noteId)).findFirst().orElseThrow(() -> (new UserException(environment.getProperty("note.invalid"))));
	Notes note = noteRepository.findByNoteId(noteId);
...
//				redisService.deleteMap("redisKey",noteId);
				System.out.println("mohitId"+noteId);
